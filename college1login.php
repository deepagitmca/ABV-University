           ...
           <tr>
            ...
            <tr bgcolor="#F8F8F8">
                <td colspan="2"><form id="form1" name="form1" method="post">
                  <p style="font-weight: 900; font-size: 24px;"><br>
                  </p>
                  <table width="400" border="0" align="center" cellpadding="10" cellspacing="2">
                    <tbody>
                      <tr>
                        <td colspan="2" bgcolor="#EDF5ED" style="text-align: center; font-size: 24px; font-weight: 900; color: #0A0A0A;">GIT College </td>
                      </tr>
                      <tr>
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$sql1 = "SELECT * from college1admin where username = '$uname' and password = '$pass'";
	...
	if($result1->num_rows == 1)
	{
		 ...
		 echo "<script> if(confirm('Login Successfull')) window.location='college1admindashboard.php'; </script>";
