...
<html>
	...
	$sql1="Select *from college1student";
	// Execute the query
                ...
                <tr>
                  <td bgcolor="#F8F8F8"> 
                   ...
                   <p>
                     <?php
						include("myconn1.php");
						$sql="SELECT *from college1student";
                   ...
                   <p style="font-size: 18px; font-weight: bold; text-align: center;">GIT College student data </p>
                   ...
                   <br>
                   <p style="text-align: center"><a href="college1deleteallstudenrdata.php">Delete all</a></p>
                  <p>&nbsp;</p></td>
                </tr>
              	</tbody>
              </table></td>
