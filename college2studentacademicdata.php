...
<html>
	...
	$sql1="Select *from college2academicdata";
	// Execute the query
                ...
                <tr>
                  <td bgcolor="#F8F8F8"> 
                   ...
                   <p>
                     <?php
						include("myconn1.php");
						$sql="SELECT *from college2academicdata";
                   ...
                   <p style="font-size: 18px; font-weight: bold; text-align: center;">Jain College student academic data </p>
                   ...
                   <br>
                   <p style="text-align: center"><a href="college2deleteallacademicdata.php">Delete all</a></p>
                  <p>&nbsp;</p></td>
                </tr>
              	</tbody>
              </table></td>
