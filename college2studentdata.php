...
<html>
	...
	$sql1="Select *from college2student";
	// Execute the query
                ...
                <tr>
                  <td bgcolor="#F8F8F8"> 
                   ...
                   <p>
                     <?php
						include("myconn1.php");
						$sql="SELECT *from college2student";
                   ...
                   <p style="font-size: 18px; font-weight: bold; text-align: center;">Jain College student data </p>
                   ...
                   <br>
                   <p style="text-align: center"><a href="college2deleteallstudenrdata.php">Delete all</a></p>
                  <p>&nbsp;</p></td>
                </tr>
              	</tbody>
              </table></td>
