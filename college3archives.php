              ...
              <tbody>
                <tr>
                  <td bgcolor="#F8F8F8"> 
                   ...
                   <p style="text-align: center; font-size: 24px; font-weight: bold;">RVCE College archieve data </p>
                   <table width="730" border="0" align="center" cellpadding="0" cellspacing="0">
                     <tbody>
                       ...
                       <tr>
                         ...
                         <td bgcolor="#FFFFFF" style="text-align: center"><a href="college3deletedata.php?sdata=<?php echo $sdata1;?>&adata=<?php echo $adata1;?>&edata=<?php echo $edata1;?>&date=<?php echo $date1;?>"> Delete record </a></td>
                       </tr>
                       <?php
						}
						}
                   ...
                   <table width="400" border="0" cellspacing="4" cellpadding="4">
                     <tbody>
                       <tr>
                         <td><a href="college3studentdata.php">View student data</a></td>
                         <td><a href="college3studentacademicdata.php">View academic performnace</a></td>
                       </tr>
                     </tbody>
                   </table>
                   <p></p>
