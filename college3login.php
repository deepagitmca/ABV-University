            ...
            <tr bgcolor="#F8F8F8">
                <td colspan="2"><form id="form1" name="form1" method="post">
                  ...
                  <table width="400" border="0" align="center" cellpadding="10" cellspacing="2">
                    <tbody>
                      <tr>
                        <td colspan="2" bgcolor="#EFF8EF" style="text-align: center"><span style="text-align: center; font-size: 24px; font-weight: 900;">RVCE College </span></td>
                      </tr>
                      <tr>
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$sql2 = "SELECT * from college3admin where username = '$uname' and password = '$pass'";
	...
	if($result2->num_rows == 1)
	{
		 ...
		 echo "<script> if(confirm('Login Successfull')) window.location='college3admindashboard.php'; </script>";
