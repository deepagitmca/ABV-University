...
<html>
	...
	$sql1="Select *from college4academicdata";
	// Execute the query
                ...
                <tr>
                  <td bgcolor="#F8F8F8"> 
                   ...
                   <p>
                     <?php
						include("myconn2.php");
						$sql="SELECT *from college4academicdata";
                   ...
                   <p style="font-size: 18px; font-weight: bold; text-align: center;">RVCE College student academic data </p>
                   ...
                   <br>
                   <p style="text-align: center"><a href="college4deleteallacademicdata.php">Delete all</a></p>
                  <p>&nbsp;</p></td>
                </tr>
              	</tbody>
              </table></td>
