...
<html>
	...
	$sql1="Select *from college4student";
	// Execute the query
                ...
                <tr>
                  <td bgcolor="#F8F8F8"> 
                   ...
                   <p>
                     <?php
						include("myconn2.php");
						$sql="SELECT *from college4student";
                   ...
                   <p style="font-size: 18px; font-weight: bold; text-align: center;"> SJBIT College student data </p>
                   ...
                   <br>
                   <p style="text-align: center"><a href="college4deleteallstudenrdata.php">Delete all</a></p>
                  <p>&nbsp;</p></td>
                </tr>
              	</tbody>
              </table></td>
