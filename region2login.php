            ...
            <tr bgcolor="#F8F8F8">
                <td colspan="2"> <p>&nbsp;</p>
                  ...
                  <table width="400" border="0" align="center" cellpadding="10" cellspacing="2">
                    <tbody>
                      <tr>
                        <td colspan="2" bgcolor="#FFFFFF" style="text-align: center; font-size: 24px; font-weight: 900;">Bangalore Region</td>
                      </tr>
                      <tr>
                        <td colspan="2" bgcolor="#BBBBBB" style="text-align: center"> <h2>Admin Login Form </h2></td>
                        </tr>
                      <tr>
                        <td>Username</td>
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$sql2 = "SELECT * from region2admin where username = '$uname' and password = '$pass'";
	...
	if($result2->num_rows == 1)
	{
		 ...
		 echo "<script> if(confirm('Login Successfull')) window.location='region2admindashboard.php'; </script>";
