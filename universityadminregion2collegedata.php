  ...
  ?>
        <table width="1000" border="0" cellspacing="0" cellpadding="0" align="center">
         <tbody>
            ...
            <tr bgcolor="#F8F8F8">
                <td colspan="2">  <h1 align="center"> <p>Bangalore region college data</p> </h1>
                 <?php
						include("myconn2.php");
						$sql="SELECT *from college3data";
						$result=$conn2->query($sql);
                  ...
                  <table width="738" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tbody>
                      <tr>
                        <th width="142" height="38" bgcolor="#C3C3C3" style="text-align: center" scope="col"> College code </th>
                      ...
                      <?php 
							...
							?>
                      <tr>
                        <td height="35" bgcolor="#FFFFFF" style="text-align: center"><?php echo $colcode;?></td>
                      ...
                      <?php
						   ...
						   while($row1=$result1->fetch_assoc())
							...
							?>
                      <tr>
                        <td height="37" bgcolor="#FFFFFF" style="text-align: center"><?php echo $colcode1;?></td>
