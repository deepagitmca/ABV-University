            ...
            <tr bgcolor="#F8F8F8">
                <td colspan="2"> <p>&nbsp;</p>
                  ...
                  <table width="400" border="0" align="center" cellpadding="10" cellspacing="2">
                    <tbody>
                      <tr>
                        <td colspan="2" bgcolor="#FFFFFF" style="text-align: center; font-size: 24px; font-weight: bold;">University</td>
                      </tr>
                      <tr>
                        <td colspan="2" bgcolor="#C1C1C1" style="text-align: center"> <h2>Admin Login Form </h2></td>
                        </tr>
                      <tr>
                        <td>Username</td>
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$sql3 = "SELECT * from universityadmin where username = '$uname' and password = '$pass'";
	$result3 = $conn3->query($sql3);
	if($result3->num_rows == 1)
	{
		  // create a session object name uname and assign username to it
		  $_SESSION["auname"]=$uname;
		 echo "<script> if(confirm('Login Successfull')) window.location='universityadmindashboard.php'; </script>";
